    ...
    <div className={cn(shellWideClass, 'c2k-mobile-scroll-pad py-4 sm:py-6')}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[minmax(240px,260px)_minmax(0,1fr)_minmax(260px,300px)]">
        ...
        <div className="hidden lg:block">
          ...
          <FindPeopleLeftRail {...filterRailProps} />
        ...
        <main className="min-w-0">
          ...
          <div className="mb-2 flex flex-col gap-2 sm:mb-4 sm:flex-row sm:items-center sm:gap-3">
        ...
        <div className="hidden lg:block">
          ...
          <FindPeopleRightRail suggested={suggestedPool} useDemoFallback={useDemoFallback} />
