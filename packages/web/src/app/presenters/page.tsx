...
export default function PresentersDirectoryPage() {
  ...
  return (
    ...
    <div className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 rounded-2xl border border-dc-border bg-dc-elevated/95 p-4 sm:p-5 shadow-[var(--dc-shadow-soft)]">
      ...
      <div className="mb-4 flex flex-col gap-3 sm:mb-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <TextInput
          ...
          className="w-full max-w-md min-h-11 rounded-xl"
        ...
        <div className="mb-6 -mx-1 flex items-center gap-2 overflow-x-auto px-1 pb-1 c2k-no-scrollbar">
          ...
          {topTags.map((t) => {
            ...
            return (
              ...
              <button
                ...
                className={`shrink-0 rounded-full px-3 py-1.5 text-xs font-medium transition-colors min-h-9 ${
          ...
          {activeTag ?
            ...
            <button
              ...
              className="shrink-0 text-xs text-dc-accent hover:underline min-h-9 px-2"
      ...
      : status === 'error' ?
        ...
        <EmptyState
          ...
          className="rounded-2xl border border-dc-border bg-dc-elevated/80 shadow-[var(--dc-shadow-soft)] mb-6"
          ...
          {hasMore ?
            ...
            <div className="mt-8 flex justify-center">
              ...
              <button
                ...
                className="min-h-11 rounded-xl px-6 py-2 text-sm font-medium bg-dc-elevated-muted text-dc-text hover:bg-dc-elevated-solid disabled:opacity-60"
