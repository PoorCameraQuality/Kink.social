    ...
    <div className="mx-auto max-w-[1440px] px-4 py-6 sm:px-6 lg:px-8">
      <header className="mb-4 max-w-3xl md:mb-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-dc-muted hidden sm:block">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,1fr)_280px]">
        <main className="min-w-0">
          ...
          <nav className="-mx-1 mt-4 flex items-center gap-2 overflow-x-auto px-1 pb-1 c2k-no-scrollbar" aria-label="Media format">
