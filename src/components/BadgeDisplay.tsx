 ...
 * C2K palette; no raw trust score exposed.
 */
export type BadgeId =
  | 'event_verified'
  | 'mentor'
      ...
      {visible.map((id) => {
        ...
        return (
          <span
            ...
            role="listitem"
            title={config.title}
            className={`inline-flex items-center rounded-md bg-c2k-accent-primary/15 text-c2k-accent-primary ${sizeClasses} font-medium`}
          >
            {config.label}
          </span>
        )
